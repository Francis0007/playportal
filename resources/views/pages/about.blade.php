            ...
            <div class="about-content py-lg-5 py-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 about-info">
                        ...
                        <p class="my-xl-4 my-lg-3 my-md-4 my-3">Playverse is providing a platform to publish your Application with minimum charges.
                        </p>
                        ...
                        <ul>
                            ...
                            <p><i class="fa fa-check-square" aria-hidden="true" style="color: green"> </i> PlayVerse promote top 50 Apps listed by editor's</p>
